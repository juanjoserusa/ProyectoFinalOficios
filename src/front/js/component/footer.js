        ...
        <div className="row d-flex justify-content-evenly">
          <div className="col-3 col-md-3 cards me-2">
            ...
            <div className="row">
              ...
              <a  className="enlacesAyuda"  href="#">Guia para nuevo usuario</a>
              <a  className="enlacesAyuda"  href="#">Guia para nuevo profesional</a>
              <a  className="enlacesAyuda"  href="#">Acerca de HandleHome</a>
            </div>
          </div>
          <div className="col-3 col-md-3 cards me-2">
            <h3>Legal</h3>
            ...
            <div className="row">
              ...
              <a  className="enlacesAyuda"  href="#">Privacy Policy</a>
              <a  className="enlacesAyuda"  href="#">Terms of Service</a>
              <a  className="enlacesAyuda"  href="#">Law Enforcement</a>
            </div>
          </div>
        </div>
